...
public enum GMDType: Int {
    ...
    case Rotation3D, Accessibility, AccountBalance, AccountBalanceWallet, AccountBox, AccountCircle, AddShoppingCart, Alarm, AlarmAdd, AlarmOff, AlarmOn, Android, Announcement, AspectRatio, Assessment, Assignment, AssignmentInd, AssignmentLate, AssignmentReturn, AssignmentReturned, AssignmentTurnedIn, Autorenew, Backup, Book, Bookmark, BookmarkBorder, BugReport, Build, Cached, CameraEnhance, CardGiftcard, CardMembership, CardTravel, ChangeHistory, CheckCircle, ChromeReaderMode, Class, Code, CreditCard, Dashboard, Delete, Description, Dns, Done, DoneAll, Eject, Event, EventSeat, ExitToApp, Explore, Extension, Face, Favorite, FavoriteBorder, Feedback, FindInPage, FindReplace, FlightLand, FlightTakeoff, FlipToBack, FlipToFront, GetApp, Gif, Grade, GroupWork, Help, HelpOutline, HighlightOff, History, Home, HourglassEmpty, HourglassFull, Http, Https, Info, InfoOutline, Input, InvertColors, Label, LabelOutline, Language, Launch, List, Lock, LockOpen, LockOutline, Loyalty, MarkunreadMailbox, NoteAdd, OfflinePin, OpenInBrowser, OpenInNew, OpenWith, Pageview, Payment, PermCameraMic, PermContactCalendar, PermDataSetting, PermDeviceInformation, PermIdentity, PermMedia, PermPhoneMsg, PermScanWifi, PictureInPicture, PlayForWork, Polymer, PowerSettingsNew, Print, QueryBuilder, QuestionAnswer, Receipt, Redeem, Reorder, ReportProblem, Restore, Room, Schedule, Search, Settings, SettingsApplications, SettingsBackupRestore, SettingsBluetooth, SettingsBrightness, SettingsCell, SettingsEthernet, SettingsInputAntenna, SettingsInputComponent, SettingsInputComposite, SettingsInputHdmi, SettingsInputSvideo, SettingsOverscan, SettingsPhone, SettingsPower, SettingsRemote, SettingsVoice, Shop, ShopTwo, ShoppingBasket, ShoppingCart, SpeakerNotes, Spellcheck, StarRate, Stars, Store, Subject, SupervisorAccount, SwapHoriz, SwapVert, SwapVerticalCircle, SystemUpdateAlt, Tab, TabUnselected, Theaters, ThumbDown, ThumbUp, ThumbsUpDown, Toc, Today, Toll, TrackChanges, Translate, TrendingDown, TrendingFlat, TrendingUp, TurnedIn, TurnedInNot, VerifiedUser, ViewAgenda, ViewArray, ViewCarousel, ViewColumn, ViewDay, ViewHeadline, ViewList, ViewModule, ViewQuilt, ViewStream, ViewWeek, Visibility, VisibilityOff, Work, YoutubeSearchedFor, ZoomIn, ZoomOut, AddAlert, Error, ErrorOutline, Warning, Airplay, Album, AvTimer, ClosedCaption, Equalizer, Explicit, FastForward, FastRewind, Forward10, Forward30, Forward5, Games, Hd, Hearing, HighQuality, LibraryAdd, LibraryBooks, LibraryMusic, Loop, Mic, MicNone, MicOff, Movie, NewReleases, NotInterested, Pause, PauseCircleFilled, PauseCircleOutline, PlayArrow, PlayCircleFilled, PlayCircleOutline, PlaylistAdd, Queue, QueueMusic, Radio, RecentActors, Repeat, RepeatOne, Replay, Replay10, Replay30, Replay5, Shuffle, SkipNext, SkipPrevious, Snooze, SortByAlpha, Stop, Subtitles, SurroundSound, VideoLibrary, Videocam, VideocamOff, VolumeDown, VolumeMute, VolumeOff, VolumeUp, Web, Business, Call, CallEnd, CallMade, CallMerge, CallMissed, CallReceived, CallSplit, Chat, ChatBubble, ChatBubbleOutline, ClearAll, Comment, ContactPhone, Contacts, DialerSip, Dialpad, Email, Forum, ImportExport, InvertColorsOff, LiveHelp, LocationOff, LocationOn, Message, NoSim, Phone, PhonelinkErase, PhonelinkLock, PhonelinkRing, PhonelinkSetup, PortableWifiOff, PresentToAll, RingVolume, SpeakerPhone, StayCurrentLandscape, StayCurrentPortrait, StayPrimaryLandscape, StayPrimaryPortrait, SwapCalls, Textsms, Voicemail, VpnKey, Add, AddBox, AddCircle, AddCircleOutline, Archive, Backspace, Block, Clear, ContentCopy, ContentCut, ContentPaste, Create, Drafts, FilterList, Flag, FontDownload, Forward, Gesture, Inbox, Link, Mail, Markunread, Redo, Remove, RemoveCircle, RemoveCircleOutline, Reply, ReplyAll, Report, Save, SelectAll, Send, Sort, TextFormat, Undo, AccessAlarm, AccessAlarms, AccessTime, AddAlarm, AirplanemodeActive, AirplanemodeInactive, BatteryAlert, BatteryChargingFull, BatteryFull, BatteryStd, BatteryUnknown, Bluetooth, BluetoothConnected, BluetoothDisabled, BluetoothSearching, BrightnessAuto, BrightnessHigh, BrightnessLow, BrightnessMedium, DataUsage, DeveloperMode, Devices, Dvr, GpsFixed, GpsNotFixed, GpsOff, GraphicEq, LocationDisabled, LocationSearching, NetworkCell, NetworkWifi, Nfc, ScreenLockLandscape, ScreenLockPortrait, ScreenLockRotation, ScreenRotation, SdStorage, SettingsSystemDaydream, SignalCellular4Bar, SignalCellularConnectedNoInternet4Bar, SignalCellularNoSim, SignalCellularNull, SignalCellularOff, SignalWifi4Bar, SignalWifi4BarLock, SignalWifiOff, Storage, Usb, Wallpaper, Widgets, WifiLock, WifiTethering, AttachFile, AttachMoney, BorderAll, BorderBottom, BorderClear, BorderColor, BorderHorizontal, BorderInner, BorderLeft, BorderOuter, BorderRight, BorderStyle, BorderTop, BorderVertical, FormatAlignCenter, FormatAlignJustify, FormatAlignLeft, FormatAlignRight, FormatBold, FormatClear, FormatColorFill, FormatColorReset, FormatColorText, FormatIndentDecrease, FormatIndentIncrease, FormatItalic, FormatLineSpacing, FormatListBulleted, FormatListNumbered, FormatPaint, FormatQuote, FormatSize, FormatStrikethrough, FormatTextdirectionLToR, FormatTextdirectionRToL, FormatUnderlined, Functions, InsertChart, InsertComment, InsertDriveFile, InsertEmoticon, InsertInvitation, InsertLink, InsertPhoto, MergeType, ModeComment, ModeEdit, MoneyOff, Publish, SpaceBar, StrikethroughS, VerticalAlignBottom, VerticalAlignCenter, VerticalAlignTop, WrapText, Attachment, Cloud, CloudCircle, CloudDone, CloudDownload, CloudOff, CloudQueue, CloudUpload, FileDownload, FileUpload, Folder, FolderOpen, FolderShared, Cast, CastConnected, Computer, DesktopMac, DesktopWindows, DeveloperBoard, DeviceHub, Dock, Gamepad, Headset, HeadsetMic, Keyboard, KeyboardArrowDown, KeyboardArrowLeft, KeyboardArrowRight, KeyboardArrowUp, KeyboardBackspace, KeyboardCapslock, KeyboardHide, KeyboardReturn, KeyboardTab, KeyboardVoice, Laptop, LaptopChromebook, LaptopMac, LaptopWindows, Memory, Mouse, PhoneAndroid, PhoneIphone, Phonelink, PhonelinkOff, PowerInput, Router, Scanner, Security, SimCard, Smartphone, Speaker, SpeakerGroup, Tablet, TabletAndroid, TabletMac, Toys, Tv, Watch, AddToPhotos, Adjust, Assistant, AssistantPhoto, Audiotrack, BlurCircular, BlurLinear, BlurOff, BlurOn, Brightness1, Brightness2, Brightness3, Brightness4, Brightness5, Brightness6, Brightness7, BrokenImage, Brush, Camera, CameraAlt, CameraFront, CameraRear, CameraRoll, CenterFocusStrong, CenterFocusWeak, Collections, CollectionsBookmark, ColorLens, Colorize, Compare, ControlPoint, ControlPointDuplicate, Crop, Crop169, Crop32, Crop54, Crop75, CropDin, CropFree, CropLandscape, CropOriginal, CropPortrait, CropSquare, Dehaze, Details, Edit, Exposure, ExposureNeg1, ExposureNeg2, ExposurePlus1, ExposurePlus2, ExposureZero, Filter, Filter1, Filter2, Filter3, Filter4, Filter5, Filter6, Filter7, Filter8, Filter9, Filter9Plus, FilterBAndW, FilterCenterFocus, FilterDrama, FilterFrames, FilterHdr, FilterNone, FilterTiltShift, FilterVintage, Flare, FlashAuto, FlashOff, FlashOn, Flip, Gradient, Grain, GridOff, GridOn, HdrOff, HdrOn, HdrStrong, HdrWeak, Healing, Image, ImageAspectRatio, Iso, Landscape, LeakAdd, LeakRemove, Lens, Looks, Looks3, Looks4, Looks5, Looks6, LooksOne, LooksTwo, Loupe, MonochromePhotos, MovieCreation, MusicNote, Nature, NaturePeople, NavigateBefore, NavigateNext, Palette, Panorama, PanoramaFishEye, PanoramaHorizontal, PanoramaVertical, PanoramaWideAngle, Photo, PhotoAlbum, PhotoCamera, PhotoLibrary, PhotoSizeSelectActual, PhotoSizeSelectLarge, PhotoSizeSelectSmall, PictureAsPdf, Portrait, RemoveRedEye, Rotate90DegreesCcw, RotateLeft, RotateRight, Slideshow, Straighten, Style, SwitchCamera, SwitchVideo, TagFaces, Texture, Timelapse, Timer, Timer10, Timer3, TimerOff, Tonality, Transform, Tune, ViewComfy, ViewCompact, Vignette, WbAuto, WbCloudy, WbIncandescent, WbIridescent, WbSunny, Beenhere, Directions, DirectionsBike, DirectionsBoat, DirectionsBus, DirectionsCar, DirectionsRailway, DirectionsRun, DirectionsSubway, DirectionsTransit, DirectionsWalk, Flight, Hotel, Layers, LayersClear, LocalActivity, LocalAirport, LocalAtm, LocalBar, LocalCafe, LocalCarWash, LocalConvenienceStore, LocalDining, LocalDrink, LocalFlorist, LocalGasStation, LocalGroceryStore, LocalHospital, LocalHotel, LocalLaundryService, LocalLibrary, LocalMall, LocalMovies, LocalOffer, LocalParking, LocalPharmacy, LocalPhone, LocalPizza, LocalPlay, LocalPostOffice, LocalPrintshop, LocalSee, LocalShipping, LocalTaxi, Map, MyLocation, Navigation, PersonPin, PinDrop, Place, RateReview, RestaurantMenu, Satellite, StoreMallDirectory, Terrain, Traffic, Apps, ArrowBack, ArrowDropDown, ArrowDropDownCircle, ArrowDropUp, ArrowForward, Cancel, Check, ChevronLeft, ChevronRight, Close, ExpandLess, ExpandMore, Fullscreen, FullscreenExit, Menu, MoreHoriz, MoreVert, Refresh, Adb, AirlineSeatFlat, AirlineSeatFlatAngled, AirlineSeatIndividualSuite, AirlineSeatLegroomExtra, AirlineSeatLegroomNormal, AirlineSeatLegroomReduced, AirlineSeatReclineExtra, AirlineSeatReclineNormal, BluetoothAudio, ConfirmationNumber, DiscFull, DoNotDisturb, DoNotDisturbAlt, DriveEta, EventAvailable, EventBusy, EventNote, FolderSpecial, LiveTv, Mms, More, NetworkLocked, OndemandVideo, PersonalVideo, PhoneBluetoothSpeaker, PhoneForwarded, PhoneInTalk, PhoneLocked, PhoneMissed, PhonePaused, Power, SdCard, SimCardAlert, Sms, SmsFailed, Sync, SyncDisabled, SyncProblem, SystemUpdate, TapAndPlay, TimeToLeave, Vibration, VoiceChat, VpnLock, Wc, Wifi, Cake, Domain, Group, GroupAdd, LocationCity, Mood, MoodBad, Notifications, NotificationsActive, NotificationsNone, NotificationsOff, NotificationsPaused, Pages, PartyMode, People, PeopleOutline, Person, PersonAdd, PersonOutline, PlusOne, Poll, Public, School, Share, Whatshot, CheckBox, CheckBoxOutlineBlank, IndeterminateCheckBox, RadioButtonChecked, RadioButtonUnchecked, Star, StarBorder, StarHalf
